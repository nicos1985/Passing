...
urlpatterns = [
    ...
    path('ajax/object-metadata/', get_object_metadata, name='ajax-object-metadata'),
    path('evaluation/<int:pk>/', RiskEvaluationDetailView.as_view(), name='evaluation-detail'),
    path('evaluation-update/<int:pk>/', views.RiskEvaluationUpdateView.as_view(), name='evaluation-update'),
